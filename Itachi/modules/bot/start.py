from Itachi import app, API_ID, API_HASH
...
# © By Itz-Itachi Your motherfucker if uh Don't gives credits.
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        client = Client(name="Melody", api_id=API_ID, api_hash=API_HASH, session_string=phone, plugins=dict(root="Itachi/modules"))
        await client.start()
